...
<This is a generic example for Flashing an operating system using the "Fastboot" method. It is important to maintain this format/structure when developing your instructions >

This section show how to install a new operating system to your BB2260 using the fastboot method on a Linux host computer.

***

- **Step 1**: Make sure fastboot is set up on host computer
- **Step 2**: Connect host computer to BB2260
- **Step 3**: Boot BB2260 into fastboot mode
- **Step 4**: Flash Bootloader
- **Step 5**: Recall location of all downloaded files
- **Step 6**: Unzip all files
- **Step 7**: Flash all files to the BB2260
- **Step 8**: Reboot BB2260
...
- BB2260 must be powered off (unplugged from power)
- Make sure microSD card slot on BB2260 is empty
- S6 switch on BB2260 must be set to ‘0-0-0-0’. All switches should be in “off” position
- Connect USB to microUSB cable from host computer to BB2260

#### **Step 3**: Boot BB2260 into fastboot mode

**Please read all bullet points before attempting**

- Press and hold the Vol (-) button on the BB2260, this is the S4 button. BB2260 should still NOT be powered on
- While holding the Vol (-) button, power on the BB2260 by plugging it in
- Once BB2260 is plugged into power, release your hold on the Vol (-) button.
...
**At this point you should be connected to your BB2260 with a USB to microUSB cable. Your BB2260 should be booted into fastboot mode and ready to be flashed with the appropriate images.**
...
#### **Step 7**: Flash all images to the BB2260
